...
export function BottomRightCorner() {
  return (
    ...
    >
      ...
      {/* Content */}
      <Link href="/chat" className="group/corner flex items-center gap-3 sm:gap-4 md:gap-6 select-none cursor-pointer">
        {/* Circle Icon */}
        <div className="bg-[rgba(30,50,90,0.05)] w-10 h-10 md:w-14 md:h-14 rounded-full flex items-center justify-center border border-[rgba(30,50,90,0.1)] group-hover/corner:bg-[rgba(30,50,90,0.1)] transition-colors">
        ...
        <div className="flex flex-col text-left">
          ...
          <div className="flex items-center gap-1 text-[rgba(30,50,90,0.6)] group-hover/corner:text-[rgba(30,50,90,0.8)] transition-colors">
            <span className="text-[12px] md:text-[15px] font-normal">Ask Agent</span>
